...
while opciones_menu != 5:
    if opciones_menu == 1:
        ...
        saldo_cuenta = saldo_cuenta + 32500
        cantidad_bandeja = cantidad_bandeja + 1
        total_platos = total_platos + 1
    elif opciones_menu == 2:
        print("Agregada con exito")
        saldo_cuenta = saldo_cuenta + 27050
        cantidad_ajiaco = cantidad_ajiaco + 1
        total_platos = total_platos + 1
    elif opciones_menu == 3:
        print("Agregada con exito")
        saldo_cuenta = saldo_cuenta + 35750
        cantidad_camarones = cantidad_camarones + 1
        total_platos = total_platos + 1
    elif opciones_menu == 4:
        print("Agregada con exito")
        saldo_cuenta = saldo_cuenta + 30525
        cantidad_sancocho = cantidad_sancocho + 1
        total_platos = total_platos + 1
...
print("La cantidad de platos solicitados es de: ", total_platos)
print("De los cuales estan repartidos en: ")
print("Bandejas paisa: ", cantidad_bandeja)
print("ajiacos: ", cantidad_ajiaco)
print("arroz con camarones: ", cantidad_camarones)
print("sancocho: ", cantidad_sancocho)
print("La cuenta es de: ", saldo_cuenta, " Muchas gracias por visitarnos")